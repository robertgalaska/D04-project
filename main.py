...
def combine_torque(engine_torque, aero_torque0, aero_torque10):
    total_torque0 = aero_torque0 + engine_torque
    total_torque10 = aero_torque10 + engine_torque
...
shearneg, shearpos = combine_shearloads(aero_shear_CLd_min, aero_shear_CLd_25, inertial_shear)
combine_bendingmoment(aero_moment_CLd_min, aero_moment_CLd_25, engine_bending, inertial_moment)
torqueneg, torquepos = combine_torque(engine_torque, aero_torque_CLd_min, aero_torque_CLd_25)
